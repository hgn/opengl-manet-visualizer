...
int init_skybox(void)
{
	...
	image[0] = load_image("textures/skydome-02/xn.bmp", BMP_TYPE);
	if (!image)
		die("Can't load texture for skydome");

	image[1] = load_image("textures/skydome-02/xp.bmp", BMP_TYPE);
	if (!image)
		die("Can't load texture for skydome");

	image[2] = load_image("textures/skydome-02/yn.bmp", BMP_TYPE);
	if (!image)
		die("Can't load texture for skydome");

	image[3] = load_image("textures/skydome-02/yp.bmp", BMP_TYPE);
	if (!image)
		die("Can't load texture for skydome");

	image[4] = load_image("textures/skydome-02/zn.bmp", BMP_TYPE);
	if (!image)
		die("Can't load texture for skydome");

	image[5] = load_image("textures/skydome-02/zp.bmp", BMP_TYPE);
	if (!image)
		die("Can't load texture for skydome");
